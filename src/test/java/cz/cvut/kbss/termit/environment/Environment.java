...
public class Environment {
    ...
    public static void addModelStructureForRdfsInference(EntityManager em) {
        ...
        try (final RepositoryConnection conn = repo.getConnection()) {
            ...
            conn.add(
                    new URL("https://raw.githubusercontent.com/opendata-mvcr/ssp/master/content/vocabularies/d-sgov-pracovn%C3%AD-prostor-0.0.1/d-sgov-pracovn%C3%AD-prostor-0.0.1-model.ttl"),
